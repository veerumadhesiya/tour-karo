      ...
      <div className='max-w-7xl mx-auto px-4'>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
            <div>
                ...
                <p className='text-sm'>We're dedicateds to making your travel dreams comes true with expertly curated tours and unforgettable experiences.</p>
            </div>
